...
import com.example.chgk.model.db.entity.GameQuestion;
import com.example.chgk.model.db.entity.QuestionResult;
...
public interface QuestionResultRepo extends JpaRepository<QuestionResult, Long> {
    ...
    @Query(nativeQuery = true, value = "select * from question_results as qr where qr.question_id = :questionId and qr.team_id = :teamId")
